export default [
    ...
    },
    {
      ...
      {
        id: 'q9',
        text: 'Which lifecycle method is invoked immediately after a component is rendered on the DOM?',
        answers: [
            'componentDidMount ',
        ' componentDidUpdate ',
         'componentWillMount ',
      ...
      {
        id: 'q10',
        text: 'Which method is used to update the state of a class component in React? ',
        answers: [
            'this.setState()' ,
            'this.updateState()' ,
            'this.modifyState()' ,
